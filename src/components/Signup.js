          ...
          <h1 className='text-center my-2' style={{color:props.mode==='light'?'black':'#DDDDDD'}}>Sign Up</h1>
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    <input autoComplete="off" type="text" className={`form-control bg-${props.mode==='light'?'light':'dark'}`} style={{color:props.mode==='light'?'black':'#DDDDDD'}} id="name" name='name' onChange={onChange} aria-describedby="emailHelp" required />
                </div>
                <div className="mb-3">
                    ...
                    <input autoComplete="off" type="date" className={`form-control bg-${props.mode==='light'?'light':'dark'}`} style={{color:props.mode==='light'?'black':'#DDDDDD'}} id="birthdate" name='birthdate' onChange={onChange} aria-describedby="emailHelp" required />
                </div>
                <div className="mb-3">
                  <div className="form-check gender mx-2">
                    ...
                    <input autoComplete="off" htmlFor="male" className={`showpass form-check-input bg-${props.mode==='light'?'':'dark'}`} type="checkbox" value="Male" id="male" name='gender' onChange={onChange} aria-describedby="emailHelp"/>
                  </div>
                  ...
                  <label htmlFor="female" className="form-label" style={{color:props.mode==='light'?'black':'#DDDDDD'}}>Female</label>
                    <input autoComplete="off" htmlFor="female" className={`showpass form-check-input bg-${props.mode==='light'?'':'dark'}`} type="checkbox" value="fe-male" id="Female" name='gender' onChange={onChange} aria-describedby="emailHelp"/>
                  </div>
                </div>
                <div className="mb-3">
                <i className="fa fa-envelope mx-1" style={{color:props.mode==='light'?'black':'grey'}} aria-hidden="true"></i>
                    ...
                    <input autoComplete="off" type="email" className={`form-control email bg-${props.mode==='light'?'light':'dark'}`} style={{color:props.mode==='light'?'black':'#DDDDDD'}} id="email" name='email' onChange={onChange} aria-describedby="emailHelp" required/>
                ...
                <div className="mb-3">
                    ...
                    <input autoComplete="off" type="text" className={`form-control bg-${props.mode==='light'?'light':'dark'}`} style={{color:props.mode==='light'?'black':'#DDDDDD'}} id="mobileno" name='mobileno' onChange={onChange} aria-describedby="emailHelp" minLength='10' required />
                </div>
                <div className="mb-3">
                    ...
                    <input autoComplete="off" type="text" className={`form-control bg-${props.mode==='light'?'light':'dark'}`} style={{color:props.mode==='light'?'black':'#DDDDDD'}} id="bio" name='bio' onChange={onChange} aria-describedby="emailHelp" required />
                </div>
                <div className="mb-3">
                    ...
                    <input autoComplete="off" type="password" className={`form-control pass bg-${props.mode==='light'?'light':'dark'}`} style={{color:props.mode==='light'?'black':'#DDDDDD'}} id="password" name='password' onChange={onChange} minLength='8' required />
                </div>
              ...
              <input autoComplete="off" type="checkbox" className={`form-check-input showpass bg-${props.mode==='light'?'none':'dark'}`} style={{borderColor:props.mode==='light'?'black':'white'}} id="exampleCheck1" onClick={handleShowpass}/>
                ...
                <i className="fa fa-key mx-1" style={{color:props.mode==='light'?'black':'grey'}} aria-hidden="true"></i>
                    ...
                    <input autoComplete="off" type="password" className={`form-control pass bg-${props.mode==='light'?'light':'dark'}`} style={{color:props.mode==='light'?'black':'#DDDDDD'}} id="cpassword" name='cpassword' onChange={onChange} minLength='8' required/>
                </div>
                <div className="mb-3 form-check">
              <input autoComplete="off" type="checkbox" className={`form-check-input showpass bg-${props.mode==='light'?'none':'dark'}`} style={{borderColor:props.mode==='light'?'black':'white'}} id="exampleCheck2" onClick={handleShocwpass}/>
